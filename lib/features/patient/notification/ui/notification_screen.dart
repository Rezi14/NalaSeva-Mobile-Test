...
import '../widgets/patient_notification_card.dart';
                              ...
                              children:
                                ...
                                children: [
                                  ...
                                  if (activeQueues.isNotEmpty) ...[
                                    ...
                                    ...activeQueues.map((q) => PatientNotificationCard(
                                  ...
                                  if (completedQueues.isNotEmpty) ...[
                                    ...
                                    const SizedBox(height: 12),
                                    ...completedQueues.map((q) => PatientNotificationCard(
                                  ...
                                  if (cancelledQueues.isNotEmpty) ...[
                                    ...
                                    const SizedBox(height: 12),
                                    ...cancelledQueues.map((q) => PatientNotificationCard(
